...
module.exports = {
  SESSION_ID: process.env.SESSION_ID || 'QUEENELISA;;;==QWtoER4wEUuhGRmJGct0Gd4RjUoNGStUXU38VRlR3S0VVO0REO5Y2XOFTVjQFaUFVRwI0apwd=2451681418432',
  ALIVE_REACT: '👋',
...
Qᴜᴇᴇɴ ᴇʟɪꜱᴀ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
  ...
  MONGODB_URL: process.env.MONGODB_URL|| 'mongosh "mongodb+srv://cluster0.ac22a.mongodb.net/" --apiVersion 1 --username dgyatou',
  PREFIX: '.$&',
  LANGUAGE: 'EN',
  PORT: process.env.PORT || 3000,
  BOT_NAME: 'queen elisa',
  OWNER_NAME: 'MrNima',
  OWNER_NUMBER: '2348141861542',
  SUDO: '2348141861542',
